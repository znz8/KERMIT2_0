...
class DTBert(nn.Module):
    ...
    def forward(self, x_sem, x_synth):
        ...
        :param x_sem: dimension of BERT
        :param x_synth: dimension of KERMIT
        :return: softmax of the prediction vector
        """
    ...
    def get_activation(self, x_sem, x_synth):
        # This function is the same of forward except we do not backpropagate the gradient
        with torch.no_grad():
            x_sem = self.bert(x_sem)[0][:, 0, :]
