...
def get_sentence(sentence, calculator):
    ...
    :param sentence: free-format text
    :param calculator: KERMIT calculator object
    :return: tree in parienthetic form, tree vector, BERT encoding of the input
    """
...
def get_two_sentences(sentence1, sentence2, calculator):
    ...
    :param sentence1: free-format text first sentence
    :param sentence2: free-format text second sentence
    :param calculator: KERMIT calculator object
    :return: tree in parienthetic form, tree vector, BERT encoding of the input
    """
...
def get_token_BERT(sentence):
    ...
    :param sentence: free-format text
    :return: BERT encoding of the input sentence
    """
...
def input_to_bert(sentences, max_len, b_s):
    ...
    :param sentences: free-format text
    :param max_len: maximum length of tokens to be considered
    :param b_s: batch size
    :return: BERT-ready input
    """
